...
La primera suposición es equivalente a que no existen oportunidades de arbitraje, pues de existir, los participantes racionales las tomarían y por oferta y demanda su precio se estabilizaría en un punto de equilibrio, el cual correspondería con el precio justo. La segunda suposición significa que todos los participantes tienen acceso a la misma información y los precios son iguales para todos, además nadie puede influir en los precios para modificarlos a su conveniencia.
...
\end{align*}
\begin{equation}
\therefore \quad dY(t)=(\mu + r_f)Y(t)dt+\sigma Y(t)dW(t). \label{C1:dY}
\end{equation}
